...
class Config:
    ...
    # Common parameters
    NUM_CLASSES = 4  # Changed from 4 to 3 (removed BASELINE and SURPRISE)
    SEED = 42
    ...
    IDX_TO_LABEL = ["Q1_Positive_Active", "Q2_Negative_Active", "Q4_Positive_Calm","Q4_Positive_Calm"]  # 3 labels
